	...
	app.Commands = []cli.Command{
		{
			...
			Description: `
    xpensetool --datadir=<datadir> genesis genesis-file.g
			...
			Subcommands: []cli.Command{
				{
					...
					Description: `
    xpensetool --datadir=<datadir> genesis json --experimental genesis-file.json
...
`,
				},
				{
					...
					Description: `
    xpensetool --datadir=<datadir> genesis fake <N> [--mode=validator]
			...
			Subcommands: []cli.Command{
				{
					...
					Action: checkLive,
					Description: `
    xpensetool --datadir=<datadir> check live
...
`,
				},
				{
					...
					Action: checkArchive,
					Description: `
    xpensetool --datadir=<datadir> check archive
...
`,
				},
				{
					...
					Description: `
    xpensetool --datadir=<datadir> events import <filenames> [--mode=validator]
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    xpensetool account new --password=file
...
For non-interactive use the passphrase can be specified with the --password flag:
    ...
    xpensetool account update --password=file <address>
...
`,
				},
				{
					...
					ArgsUsage: "<keyFile>",
					Description: `
    xpensetool account import <keyfile>
